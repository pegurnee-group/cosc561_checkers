...
public class AIBasicWithPruning extends AbstractAI {

	public AIBasicWithPruning(boolean isRed) {
		super(isRed);
	}
	...
	public MoveInterface computeMove(ArrayList<MoveInterface> legalMoves) {
		...
		SeeTheFutureTree tree = new SeeTheFutureTree(new ImaginaryBoard(null),
				this);
		return tree.getTheBestMoveWithPruning();
	}
	...
	private double totalPieces(ImaginaryBoard theImaginaryBoardToReturn) {
		double toReturn = -1.0;
